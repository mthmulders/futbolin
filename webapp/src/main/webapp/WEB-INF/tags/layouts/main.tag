...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/webjars/bootstrap/4.6.0-1/css/bootstrap.min.css">
...
<script src="${pageContext.request.contextPath}/webjars/bootstrap/4.6.0-1/js/bootstrap.min.js"></script>
</body>
