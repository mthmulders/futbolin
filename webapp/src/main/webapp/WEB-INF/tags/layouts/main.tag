...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/webjars/bootstrap/5.0.0/css/bootstrap.min.css">
...
<script src="${pageContext.request.contextPath}/webjars/bootstrap/5.0.0/js/bootstrap.min.js"></script>
</body>
